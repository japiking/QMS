...
public class  test_regist_case_delete_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			flag = qmsDB.update("QMS_QUALITYCONTROL.CIRCUMSTANCE_U002", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_regist_case_delete_do());
%>