...
public class test_case_history_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result = qmsDB.selectList("QMS_QUALITYCONTROL.HISTORY_R002", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_case_history_do());
%>