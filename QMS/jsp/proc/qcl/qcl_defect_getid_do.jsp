...
public class defect_getid_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result= qmsDB.selectList("QMS_QUALITYCONTROL.TEST_MANAGEMENT_R003", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new defect_getid_do());
%>