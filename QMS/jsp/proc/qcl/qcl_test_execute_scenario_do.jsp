...
public class test_execute_scenario_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result = qmsDB.selectList("QMS_QUALITYCONTROL.SCENARIO_R003", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_execute_scenario_do());
%>