...
public class test_execute_case_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result = qmsDB.selectList("QMS_QUALITYCONTROL.CIRCUMSTANCE_R003", param);
    		} catch (Exception e) {
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_execute_case_do());
%>