...
public class test_step_history_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result 		=	qmsDB.selectList("QMS_QUALITYCONTROL.HISTORY_R004", param);
    			countMap	=	qmsDB.selectOne("QMS_QUALITYCONTROL.TEST_MANAGEMENT_R004",param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_step_history_do());
%>