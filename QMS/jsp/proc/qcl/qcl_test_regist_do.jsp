...
public class test_regist_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result = qmsDB.selectList("QMS_QUALITYCONTROL.SCENARIO_R002", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_regist_do());
%>