...
public class test_scenario_history_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			result = qmsDB.selectList("QMS_QUALITYCONTROL.HISTORY_R001", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new test_scenario_history_do());
%>