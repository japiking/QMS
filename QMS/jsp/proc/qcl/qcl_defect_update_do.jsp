...
public class defect_update_do implements SpbBiz {
    ...
    public Map execute(HttpSession session, HttpServletRequest request, Map trmap) throws Exception{
    	...
    	try{
    		...
    		try {
    			...
    			param.put("TESTER_ID", 				dataM.get("TESTER_ID"));
    			...
    			param.put("DEFECT_ID", 				dataM.get("DEFECT_ID"));
    			param.put("DEFECT_SEQ", 			dataM.get("DEFECT_SEQ"));
    			param.put("DEL_FLAG", 				"N");
    			param.put("DEFECT_TITLE", 			dataM.get("DEFECT_TITLE"));
    			param.put("DEFECT_PROCESS_DATE", 	dataM.get("DEFECT_PROCESS_DATE"));
    			flag = qmsDB.update("QMS_DEFECT.DEFECT_MANAGEMENT_U001", param);
...
%>
<%
	request.setAttribute(SpbBiz.class.getName(), new defect_update_do());
%>