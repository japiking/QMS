...
list 							= qmsDB.selectList("QMS_BBS_ISSU.USERINFO_R002", param);
	...
	$("#aSelect").click(function() {
		$("#tbody_area tr").each(function() { 
           ...
           if( $("input:radio", this).is(":checked")) {
              $('#CONFIRM_USER_ID', opener.document).val($(this).find("#user_id").text());
              $('#CONFIRM_USER_NM', opener.document).text($(this).find("#user_nm").text()+"("+$(this).find("#user_id").text()+")");
              window.close();
           }
        }); 
	});
