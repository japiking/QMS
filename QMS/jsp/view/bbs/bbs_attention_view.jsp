...
function uf_excelSave(){
	var frm				=document.frm;
	frm.target			= "_self";
	frm.action			= "/QMS/jsp/proc/bbs/bbs_attention_view_excel_save.jsp";
	frm.submit();
}
...
<form name="frm" method="post">
	...
	<div class="wrap">
		<h3></h3>
		<div class="btnWrapR">
			<input readonly="readonly" id="INQ_DATE" name="INQ_DATE" value="<%=inq_date%>" style="width: 70px"/><!--  시작일 -->
			<a href="#FIT" class="btn" onclick="javascript:uf_inq();"><span>조회</span></a>
			<a href="#FIT" class="btn" onclick="javascript:uf_excelSave();"><span>저장</span></a>
		</div>
		<table class="list">
			<colgroup>
				<col width="20%"/>
