...
try{
	...
	if("Y".equals(strFileFlag)){
	 ...
	 param3.put("CHANEL_NAME",strChanlName);
	 param3.put("BOARD_ID",strBoardId);
	 param3.put("BBS_ID",strBbsId);
	 param3.put("SEQ",strSeq);
	 param3.put("COMPLETE_DATE",	strCmptDate1);
	 param3.put("CONFIRM_USER",		confirm_user);
	 param.put("COMPLETION_DATE",	strCmptDate2);	// 완료예정일
		 
	 updateCount	= qmsDB.update("QMS_BBS_WRITE.BOARD_U001", param3);  
 }catch(Exception e){
